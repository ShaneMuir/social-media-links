...
class Social_Links_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		$links = array(
			'facebook' => isset($instance['facebook_link']) ? esc_attr($instance['facebook_link']) : '',
			'twitter' => isset($instance['twitter_link']) ? esc_attr($instance['twitter_link']) : '',
			'linkedin' => isset($instance['linkedin_link']) ? esc_attr($instance['linkedin_link']) : '',
			'google' => isset($instance['google_link']) ? esc_attr($instance['google_link']) : ''
		);

		$icons = array(
			'facebook' => isset($instance['facebook_icon']) ? esc_attr($instance['facebook_icon']) : '',
			'twitter' => isset($instance['twitter_icon']) ? esc_attr($instance['twitter_icon']) : '',
			'linkedin' => isset($instance['linkedin_icon']) ? esc_attr($instance['linkedin_icon']) : '',
			'google' => isset($instance['google_icon']) ? esc_attr($instance['google_icon']) : ''
		);

		$icon_width = isset($instance['icon_width']) ? esc_attr($instance['icon_width']) : 32;
